...
function mf(eyes, mouth, body) {
  return [...HEAD_TOP, eyes, NOSE_GAP, mouth, ...body];
}

const SPRITES = {
  idle:         [mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL), mf(EYES_CLOSED,MOUTH_SMILE,BODY_NORMAL)],
  idle_wave:    [mf(EYES_OPEN,MOUTH_SMILE,BODY_WAVE_UP), mf(EYES_OPEN,MOUTH_SMILE,BODY_WAVE_OPEN), mf(EYES_OPEN,MOUTH_SMILE,BODY_WAVE_UP), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL)],
  idle_stretch: [mf(EYES_CLOSED,MOUTH_OH,BODY_NORMAL), mf(EYES_CLOSED,MOUTH_OH,BODY_STRETCH), mf(EYES_CLOSED,MOUTH_OH,BODY_STRETCH), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL)],
  idle_look:    [mf(EYES_LOOK_L,MOUTH_FOCUS,BODY_NORMAL), mf(EYES_LOOK_L,MOUTH_FOCUS,BODY_NORMAL), mf(EYES_LOOK_R,MOUTH_FOCUS,BODY_NORMAL), mf(EYES_LOOK_R,MOUTH_FOCUS,BODY_NORMAL), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL)],
  idle_excited: [mf(EYES_WIDE,MOUTH_GRIN,BODY_NORMAL), mf(EYES_WIDE,MOUTH_GRIN,BODY_NORMAL), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL), mf(EYES_CLOSED,MOUTH_SMILE,BODY_NORMAL)],
  active:       [mf(EYES_LOOK_L,MOUTH_FOCUS,BODY_NORMAL), mf(EYES_LOOK_R,MOUTH_FOCUS,BODY_NORMAL)],
  typing:       [mf(EYES_OPEN,MOUTH_FOCUS,BODY_TYPING_L), mf(EYES_OPEN,MOUTH_FOCUS,BODY_TYPING_R)],
  coding:       [mf(EYES_WIDE,MOUTH_BIG,BODY_TYPING_L), mf(EYES_WIDE,MOUTH_BIG,BODY_TYPING_R)],
  sleeping:     [mf(EYES_CLOSED,MOUTH_NONE,BODY_RELAXED), mf(EYES_CLOSED,MOUTH_NONE,BODY_RELAXED)],
  walking:      [mf(EYES_OPEN,MOUTH_SMILE,BODY_WALK_L), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL), mf(EYES_OPEN,MOUTH_SMILE,BODY_WALK_R), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL)],
  greeting:     [mf(EYES_WIDE,MOUTH_BIG,BODY_WAVE_UP), mf(EYES_WIDE,MOUTH_BIG,BODY_WAVE_OPEN), mf(EYES_WIDE,MOUTH_BIG,BODY_WAVE_UP), mf(EYES_OPEN,MOUTH_SMILE,BODY_NORMAL)],
};
...
const CANVAS_W = 80;
const CANVAS_H = 160;
const CHAR_X   = Math.floor((CANVAS_W - CHAR_W * SCALE) / 2);
const CHAR_Y   = CANVAS_H - CHAR_H * SCALE;
